...
* post-processing: Scripts to calculate 24-hour accumulated precipitation based on 6-hourly forecasts, and to regrid it to the PRISM grid (~4 km) using budget-conserving interpolation.
